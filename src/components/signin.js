    ...
    <div className='bg-img'>
      ...
      <div className='flex items-center justify-center mt-3'>
          <div ref={container} className='signin-container '>
            ...
            <input ref={input1} className='input' type='text' placeholder='Email or mobile number'/>
            <input ref={input2} className='input' type='password' placeholder='Password'/>
            <button ref={btn} className='signin-btn'>Sign In</button>
